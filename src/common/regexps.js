...
export default {
  ...
  'zh': /^[\u4e00-\u9fa5]+$/, // chinese
  'zhIdentity': /(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}$)/, // china id card
  'zhMobile': /^1\d{10}$/, //china mobile number
  'zhPostcode': /^\d{6}$/, //china postcode

  txHash: /^0x[a-z,0-9]{64}$/i,
}
